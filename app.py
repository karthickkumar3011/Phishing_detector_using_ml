...
# Load your models
rf_model = joblib.load('saved_models/Random_Forest.pkl')
xgb_model = joblib.load('saved_models/XGBoost.pkl')
log_reg_model=joblib.load('saved_models\LogisticRegression.pkl')
decision_tree_model=joblib.load('saved_models\DecisionTree.pkl')
knn_model=joblib.load('saved_models\KNN.pkl')
svm_model=joblib.load('saved_models\LogisticRegression.pkl')
